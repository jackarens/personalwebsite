...
<ul class="p-12">
	...
	<Fragment as="li">Replicache has some support indexing, but not first class</Fragment>
...
<Slide>
<Image src={lokiQuery} alt="LokiDB query example" layout="full-width" fit="contain" />
</Slide>
</VerticalStack>
