...
<Fragment as="div" class="flex h-full w-full flex-col items-center justify-center">
	<Image src={xkcd908} alt="XKCD 908 - The Cloud" layout="full-width" fit="contain" class="min-h-0" />
	<div class="mt-2 text-center text-sm opacity-70">_XKCD 908: The Cloud_ by Randall Munroe 2.5</div>
</Fragment>
</div>
...
<Fragment as="div">
	<Callout type="note" title='Coined by Ink & Switch, 2019'>
		"Local-first software: you own your data, in spite of the cloud" — Kleppmann, Wiggins, van
		Hardenberg, McGranaghan
	</Callout>
</Fragment>

<p class="fragment mt-4 text-sm opacity-60">
	* the server still holds the authoritative copy - more on that later
</p>
</Slide>
...
<div class="two-column !items-start">
  ...
  <Fragment as="h3">Our Advantages/Situation</Fragment>
    <ol class="p-12 pb-0">
      ...
      <ul>
        <Fragment as="li">~1,000–10,000 entries per project</Fragment>
...
<ul class="p-12">
	...
	<Fragment as="li">The camp Layer landed in - menu in a minute</Fragment>
</ul>
</div>
</div>
</Slide>
...
<ul class="p-12">
	<Fragment as="li">Two clients edit the same field → the later push wins</Fragment>
	<Fragment as="li">Every change is logged - full history per element</Fragment>
	<Fragment as="li">Users can roll back any change - an undo beats a merge dialog</Fragment>
	<Fragment as="li">Same log doubles as change tracking (who, what, when)</Fragment>
</ul>
...
<div class="two-column mt-0!">
  ...
  <div>
    ...
    export interface LokiDBElement {
      ...
      *
      * Keys (IDs) represent one of the following:
...
<ul class="p-12">
	<Fragment as="li">Where should data authority actually live — client, server, somewhere in between?</Fragment>
	<Fragment as="li">What environments does this need to run in — browser, mobile, offline entirely?</Fragment>
	<Fragment as="li">How big does a single user or scope's dataset realistically get? What is the scope?</Fragment>
	<Fragment as="li">Who's allowed to see this data, and when do you check?</Fragment>
	<Fragment as="li">What happens when two people touch the same record at once? What qualifies as a conflict?</Fragment>
	<Fragment as="li">Is eventual consistency good enough, or does this need to be right *now*? Maximum allowed round trip time?</Fragment>
</ul>
</Slide>
